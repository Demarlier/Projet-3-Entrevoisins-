...
public class NeighbourServiceTest {
    ...
    public void toggleFavoriteWithSuccess() {
        ...
        assertFalse(service.getNeighboursFavorite().contains(neighbourToFav));
        service.toggleNeighbour(neighbourToFav);
        assertTrue(service.getNeighboursFavorite().contains(neighbourToFav));
        service.toggleNeighbour(neighbourToFav);
        assertFalse(service.getNeighboursFavorite().contains(neighbourToFav));
